...
@Schema({ _id: false }) class RuleProduct { @Prop({ required: true }) productCode!: string; @Prop({ default: null }) minQuantity!: number | null; @Prop({ default: null }) maxQuantity!: number | null }
